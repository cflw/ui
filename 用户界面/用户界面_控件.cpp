...
const std::wstring &C控件文本::fg文本() const {
	return m文本;
}
const S文本样式 &C控件文本::fg文本样式() const {
	return m样式;
}
//==============================================================================
// 窗口框架
...
bool W窗口框架::f响应_i范围内(const t向量2 &a) {
	return W窗口::f响应_i范围内(a) && m标志[e容器];
}
//==============================================================================
// 空白按钮
//==============================================================================
...
void W标签::f响应_显示(const S显示参数 &a) const {
	a.m图形.f绘制文本(fg文本(), fg动画矩形(), a.m主题.fg颜色(1, 1, fg总切换().fg透明度() * m透明度), fg文本样式());
}
...
void W按钮::f响应_显示(const S显示参数 &a) const {
	...
	//文本
	if (f属性_i有文本()) {
		a.m图形.f绘制文本(fg文本(), v动画矩形, v前景色, fg文本样式());
	}
}
//==============================================================================
// 文本框
