...
// 表格排行布局
//==============================================================================
void C表格排行布局::f属性_s布局(const t向量2 &a坐标, const t向量2 &a父尺寸, float a子高度) {
	m坐标 = a坐标;
	m父尺寸 = a父尺寸;
	m子高度 = a子高度;
	m上 = a父尺寸.y * 0.5f;
}
S布局参数 C表格排行布局::f生成(float ay偏移) {
	S布局参数 v;
...
// 表格排列布局
//==============================================================================
void C表格排列布局::f属性_s布局(const t向量2 &a坐标, const t向量2 &a父尺寸) {
	m坐标 = a坐标;
	m父尺寸 = a父尺寸;
	m左 = -a父尺寸.x * 0.5f;
}
S布局参数 C表格排列布局::f生成(float ax移动) {
	S布局参数 v;
